...
func (e *Exporter) generateOutputPath(format ExportFormat) string {
	...
	return filepath.Join(home, fmt.Sprintf("claw-memory-export-%s.%s", timestamp, ext))
}
...
func (e *Exporter) exportMarkdown(data *ExportData, path string) error {
	...
	// Header
	b.WriteString("# ClawMemory Audit Report\n\n")
	...
	// Footer
	b.WriteString("---\n")
	b.WriteString("*Generated by claw-memory-tui*\n")
